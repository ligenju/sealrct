package com.my.mylibrary.dialog;
...
public class VideoSizeListDialog extends BaseDialogFragment {
    ...
    class VideoResolutionAdapter extends RecyclerView.Adapter<ItemVH> {
        ...
        public ItemVH onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LinearLayout.inflate(parent.getContext(), R.layout.item_video_size, parent);
    ...
    class ItemVH extends RecyclerView.ViewHolder {
        ...
        public ItemVH(View itemView) {
            super(itemView);
            mLbl = itemView.findViewById(R.id.tv_name);
