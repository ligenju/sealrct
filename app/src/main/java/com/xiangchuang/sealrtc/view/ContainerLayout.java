 ...
 */
public class ContainerLayout extends RelativeLayout implements VideoContainerGestureDetector.ViewContainerGestureListener,
        CoverView.ContainerNameListener {
...
//        init(context);
    ...
    @NonNull
    private RelativeLayout.LayoutParams getBigContainerParams(VideoViewManager.RenderHolder renderHolder) {
