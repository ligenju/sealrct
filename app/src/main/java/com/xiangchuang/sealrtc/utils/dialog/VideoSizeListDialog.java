package com.xiangchuang.sealrtc.utils.dialog;
...
public class VideoSizeListDialog extends BaseDialogFragment {
  ...
  class ItemVH extends RecyclerView.ViewHolder {
    ...
    TextView mLbl;
    RCRTCParamsType.RCRTCVideoResolution mData = RCRTCParamsType.RCRTCVideoResolution.RESOLUTION_480_640;
    ...
    public void onBindData(int resId) {
      if (resId == R.string.rtc_resolution_standard) {
        mData = RCRTCParamsType.RCRTCVideoResolution.RESOLUTION_360_480;
      } else if (resId == R.string.rtc_resolution_high) {
        mData = RCRTCParamsType.RCRTCVideoResolution.RESOLUTION_480_640;
      } else if (resId == R.string.rtc_resolution_ultrahigh) {
        mData = RCRTCParamsType.RCRTCVideoResolution.RESOLUTION_720_1280;
      }
