package com.xiangchuang.sealrtc.screen_cast;
        ...
        public void onTexture(int textureWidth,
            ...
            if (videoConsumer != null && enabled) {
                videoConsumer.writeTexture(
                        textureWidth, textureHeight, oexTextureId, transformMatrix, rotation, timestampNs, new Handler(new Handler.Callback() {
                            @Override
